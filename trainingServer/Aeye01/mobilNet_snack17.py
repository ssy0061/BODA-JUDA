...
model.export(export_dir='./model_float16', tflite_filename='model_fp16.tflite', quantization_config=config)
...
source = ml.TFLiteGCSModelSource.from_tflite_model_file('./model_float16/model_fp16.tflite')
...
# format 어떻게 구해야하지....
sdk_model_1 = ml.Model(display_name="snack_model", model_format=model_format)
