...
class CameraXSourceActivity : AppCompatActivity(), CompoundButton.OnCheckedChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_camera_xsource)

        Log.d(TAG, "onCreate")
        previewView = findViewById(R.id.preview_view)
        if (previewView == null) {
            Log.d(CameraXSourceActivity.TAG, "previewView is null")
        }
        graphicOverlay = findViewById(R.id.graphic_overlay)
        if (graphicOverlay == null) {
            Log.d(CameraXSourceActivity.TAG, "graphicOverlay is null")
        }
    }
    ...
    public override fun onResume() {
        ...
        if (cameraXSource != null &&
            PreferenceUtils.getCustomObjectDetectorOptionsForLivePreview(this,
                CameraXSourceActivity.localModel
            )
